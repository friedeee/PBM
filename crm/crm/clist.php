...
// Sélectionner tous les fournisseurs depuis la base de données
$requete = $variable->prepare('SELECT * FROM fournisseur');
$requete->execute();
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="add-customer.html"> <i class="fa fa-plus"></i> Ajouter un fournisseur
                                 </a>  
                              </div>
