...
<aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-users"></i><span>Structure</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="add-customer.php">Fournisseur</a></li>
                        <!--li><a href="clist.php">Liste des fournisseurs</a></li-->
                        <li><a href="add-categorie.php">Catégorie</a></li>
                        <!--li><a href="catlist.php">Liste des catégories</a></li-->
                        <li><a href="add-actif.php">Actif</a></li>
                        <!--li><a href="clist.html">Liste des actifs</a></li-->
                        <li><a href="add-agence.php">Agence</a></li>
                        <!--li><a href="clist.html">Liste des agences</a></li-->
                        <li><a href="add-service.php">Service</a></li>
                        <!--li><a href="clist.html">Liste des services</a></li-->
                        <li><a href="add-poste.php">Poste</a></li>
                        <!--li><a href="clist.html">Liste des postes</a></li-->
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-gear"></i><span>Traitement</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="deposit.php">Intégration</a></li>
                        <li><a href="expense.php">Mouvement</a></li>
                        <li><a href="transfer.html">Intervention</a></li>
                        <li><a href="view-tsaction.html">Inventaire</a></li>
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-shopping-cart"></i><span>Edition</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="invoice.html">Bon de commande</a></li>
                        <li><a href="ninvoices.html">Fiche d'actif</a></li>
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-book"></i><span>Amortissement</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="rtask.html">Amortissement générale</a></li>
                        <li><a href="atask.html">Amortissement personnalisé</a></li>
                     </ul>
                  </li>
                  <!--li class="treeview">
                     <a href="#">
                  ...
                  <li>
                     <a href="auth.php">
                     <i class="fa fa-comment"></i> <span>Authentification</span>
                     <span class="pull-right-container">
                     </span>
                     </a>
                  </li>
